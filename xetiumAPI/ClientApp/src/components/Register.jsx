...
const Register = () => {
    ...
    return (
        ...
        <form className="register-Field" id = "form">
            <div className="register-Field-left">
                ...
                <input placeholder = "Имя пользователя" type = "text" value = { name } maxLength = "20" id = "name" pattern = "[A-Za-z]{5,20}" 
    ...
    function IsNameCorrect(name) {
        const myRe = new RegExp("[A-Za-z]{5,20}")
    ...
    function IsEmailCorrect(email) {
        const myRe = new RegExp("[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$");
